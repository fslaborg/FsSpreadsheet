...
let expectedWorkbookFormat = """<div><style>.fs-table, .fs-th, .fs-td { border: 1px solid black; text-align: left; border-collapse: collapse;}</style><h3>FsWorkbook with 1 worksheets:</h3><table class="fs-table"><thead><tr><th class="fs-th"></th><th class="fs-th">Worksheet</th></tr></thead><tbody><tr><td class="fs-td">1</td><td class="fs-td">dummyWorksheet1</td></tr></tbody></table></div>"""

let expectedWorksheetFormat = """<div><style>.fs-table, .fs-th, .fs-td { border: 1px solid black; text-align: left; border-collapse: collapse;}</style><h3>dummyWorksheet1</h3><table class="fs-table"><thead><th class="fs-th"></th><th class="fs-th">A</th><th class="fs-th">B</th><th class="fs-th">C</th></thead><tbody><tr><td class="fs-td">1</td><td class="fs-td">A1</td><td class="fs-td">B1</td><td class="fs-td">C1</td></tr><tr><td class="fs-td">2</td><td class="fs-td">A2</td><td class="fs-td"></td><td class="fs-td">C2</td></tr><tr><td class="fs-td">3</td><td class="fs-td">A3</td><td class="fs-td">B3</td><td class="fs-td">C3</td></tr></tbody></table></div>"""
